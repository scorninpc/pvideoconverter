 ...
 * 
 * Fabula é um projeto open-source para um framework consistente 
 *    para ser base do projeto Fabula IDE RAD Tool.
 * Este projeto visa amadurecer o desenvolvimento das classes inacabadas
 *    do bind PHP-GTK e adicionar novas funcionalidades inexistentes
 *    do GTK, como suporte nativo à webcam e video.
 * 
 * @author Bruno Pitteli Gonçalves <bruno@pitteli.com.br>
 * @url http://code.google.com/p/fabulafw/
 * @doc http://bruno.pitteli.com.br
...
class Fabula {
	 ...
	 */
	public function GtkCodeEditor($window) {
